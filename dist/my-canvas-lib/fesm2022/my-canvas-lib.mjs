...
import { Injectable, Component, Inject, Input, EventEmitter, ViewChild, Output, NgModule } from '@angular/core';
...
class DocumentService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DocumentService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
...
class EditorMarginComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: EditorMarginComponent, deps: [{ token: i2.FormBuilder }, { token: i1.MatDialog }, { token: DocumentService }], target: i0.ɵɵFactoryTarget.Component }); }
...
class EditorFooterComponent {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: EditorFooterComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.3.12", type: EditorFooterComponent, isStandalone: true, selector: "lib-editor-footer", ngImport: i0, template: "<mat-toolbar color=\"primary\">\r\n    <mat-toolbar-row>\r\n      <span class=\"spacer\"></span>\r\n      <app-editor-margin></app-editor-margin> \r\n    </mat-toolbar-row>\r\n  </mat-toolbar>\r\n  ", styles: [".spacer{flex:1 1 auto}\n"], dependencies: [{ kind: "ngmodule", type: MatToolbarModule }, { kind: "component", type: i1$1.MatToolbar, selector: "mat-toolbar", inputs: ["color"], exportAs: ["matToolbar"] }, { kind: "directive", type: i1$1.MatToolbarRow, selector: "mat-toolbar-row", exportAs: ["matToolbarRow"] }, { kind: "component", type: EditorMarginComponent, selector: "app-editor-margin" }] }); }
}
...
class DocumentReducerService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DocumentReducerService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DocumentReducerService, providedIn: 'root' }); }
}
...
class CustomSliderVerticalComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: CustomSliderVerticalComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.3.12", type: CustomSliderVerticalComponent, isStandalone: true, selector: "lib-custom-slider-vertical", ngImport: i0, template: "<!-- <mat-slider [min]=\"-1152\" [max]=\"0\" [step]=\"96\" [vertical]=\"true\" [invert]=\"true\"\r\n            [thumbLabel]=\"true\" [value]=\"value.value\" [tickInterval]=\"96\"\r\n            (input)=\"onInputChange($event)\">\r\n</mat-slider> -->\r\n", styles: [""], dependencies: [{ kind: "ngmodule", type: MatSliderModule }] }); }
}
...
class MarginRulerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: MarginRulerComponent, deps: [{ token: DocumentReducerService }], target: i0.ɵɵFactoryTarget.Component }); }
...
class ImageUploadButtonComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: ImageUploadButtonComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.3.12", type: ImageUploadButtonComponent, isStandalone: true, selector: "app-image-upload-button", outputs: { imageSelected: "imageSelected" }, viewQueries: [{ propertyName: "fileInput", first: true, predicate: ["fileInput"], descendants: true }], ngImport: i0, template: "<input type=\"file\" #fileInput (change)=\"handleFileInputChange($event)\" accept=\"image/*\" style=\"display: none;\" />\r\n<button mat-icon-button (click)=\"handleButtonClick()\">\r\n  <span class=\"material-icons md-18\">\r\n    image\r\n    </span>\r\n</button>" }); }
}
...
export { DocumentService, MyCanvasLibModule, MyLibComponent };
//# sourceMappingURL=my-canvas-lib.mjs.map
